...
/**
 * Class to handle scanning and connecting to the Arduino's Bluetooth device (asynchronous)
 */
public class BluetoothService
{
	...
	private class AcceptThread extends Thread
	{
		...
		{
			Log.d(TAG, "AcceptThread ctor, secure: " + mSocketType);
	...
	private class ConnectThread extends Thread
	{
		...
		{
			Log.d(TAG, "ConnectThread ctor, secure: " + mSocketType);
	...
	private class ConnectedThread extends Thread
	{
		...
		{
			Log.d(TAG, "ConnectedThread ctor, secure: " + socketType);
			mmSocket = socket;
